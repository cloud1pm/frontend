...
import "./OnboardingPage.css";  // ← 추가된 부분
...
const OnboardingPage = () => {
  ...
  const handleSelect = (activity) => {
    setSolutions((prev) => ({
      ...prev,
      [step]: prev[step].includes(activity)
  ...
  return (
    <div className="ob-container">
      ...
      <div className="ob-content">
        <div className="ob-icon">{levelEmojis[step]}</div>
        ...
        <div className="ob-card">
          ...
          <div className="ob-grid">
            {solutionCandidates.map((activity) => (
              <button
                key={activity}
                onClick={() => handleSelect(activity)}
                disabled={isSubmitting}
                className={`ob-item-btn ${
                  solutions[step].includes(activity) ? "selected" : ""
                }`}
              >
